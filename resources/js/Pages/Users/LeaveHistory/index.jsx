...
export default function Index({ auth,leaveRequests }) {
    const handleFilter = (status) => {
        router.get(route('leave-history.index'), { status })
    }
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="flex justify-between ">
                            ...
                            <div className="   p-2">
                                <a href={route('leave-history.create')}
                                   className="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded float-right">Add </a>
                            </div>
                        </div>
